...
<body>
    <header>
        <a><img src="${encodedImage}" alt="Logo" width="50"></a>
        <h1><%= name %></h1>
        <p><%= managementCertification %></p>
    </header>
    <main>
        <section class="section-style">
            <h2 class="special-h2">About Me</h2>
            <p><%= aboutMe %></p>
        </section>

        <section class="section-style">
            <h2 class="special-h2">Contact Information</h2>
            <ul>
        ...
        <section class="section-style">
            ...
            <table>
                ...
                <% skills.forEach(function (skill, index) { %>
                    <tr class="<% if (index % 2 === 0) { %>even<% } %>">
                        <td><%= skill.skillName %></td>
                        <td><%= skill.skillExperience %></td>
                        <td><%= skill.level %></td>
                        <td><%= skill.traits %></td>
        ...
        <section class="section-style">
            <h2 class="special-h2">Experience</h2>
            <table>
                <tr style="background-color: #f7f7f7;">
                    <th>Position</th>
                    <th>Start Date</th>
        ...
        <section class="section-style">
            <h2 class="special-h2">Projects</h2>
